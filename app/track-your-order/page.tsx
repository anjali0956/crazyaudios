...
export default function TrackYourOrderPage() {
  ...
  const [receipt, setReceipt] = useState(searchParams.get("receipt") || "");
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        >
          <input
            ...
            placeholder="Order receipt (example: CRAZY-ORDER-...)"
        ...
        <>
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <p className="mt-2 text-lg font-semibold">{order.courierName || "Pending assignment"}</p>
            </div>
            <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
              <p className="text-sm text-gray-500">Tracking Number</p>
              <p className="mt-2 text-lg font-semibold">{order.trackingNumber || "Not available yet"}</p>
            </div>
          </section>
